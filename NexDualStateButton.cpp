...
uint32_t NexDSButton::Get_background_color_bco(uint32_t *number)
{
    String cmd;
    cmd += "get ";
    cmd += getObjName();
...
bool NexDSButton::Set_background_color_bco(uint32_t number)
{
    char buf[10] = {0};
    String cmd;
...
uint32_t NexDSButton::Get_press_background_color_bco2(uint32_t *number)
{
    String cmd;
    cmd += "get ";
    cmd += getObjName();
...
bool NexDSButton::Set_press_background_color_bco2(uint32_t number)
{
    char buf[10] = {0};
    String cmd;
